...
describe('PersonService', () => {
  ...
  describe('findAll', () => {
    it('should return paginated results', async () => {
      ...
      expect(mockQueryBuilder.orderBy).toHaveBeenCalledWith('unaccent(lower(person.alias))', 'ASC');
    });
    ...
    it('should order by name DESC when sort params provided', async () => {
      ...
      expect(mockQueryBuilder.orderBy).toHaveBeenCalledWith('unaccent(lower(person.name))', 'DESC');
    });
