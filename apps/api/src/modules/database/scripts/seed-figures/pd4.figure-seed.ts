 ...
 *
 * Layout: 2 cordons. Ring 1 = crossa/contrafort/mans/vents/laterals,
 * ring 2 = outer mans/vents/laterals. Cordó-obert closes the outer ring.
...
const figure: FigureSeed = {
  ...
  nodes: [
    ...
    // ── CORDÓ OBERT (tanca l'anell exterior) ──────────────────────────────
