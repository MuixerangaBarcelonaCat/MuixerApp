...
import { ButtonComponent, ButtonGroupComponent, InputComponent } from '@muixer/ui';
...
@Component({
  ...
  imports: [FormsModule, LucideAngularModule, ButtonComponent, ButtonGroupComponent, InputComponent],
