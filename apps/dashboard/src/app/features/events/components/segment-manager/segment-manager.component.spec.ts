  ...
  describe('displayName()', () => {
    ...
    it('auto-generates from instances when name is null', () => {
      const seg = makeSegment({
        name: null,
        instances: [
          { id: 'i1', label: null, sortOrder: 0, snapshotted: false, assignedCount: 0, projectionX: null, projectionY: null, projectionScale: 1, figureTemplate: { id: 'f1', name: 'pd4' }, compositionTemplate: null },
