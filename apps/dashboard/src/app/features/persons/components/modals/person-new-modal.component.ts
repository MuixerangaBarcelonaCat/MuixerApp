...
import { AlertComponent, ButtonComponent, InputComponent, ModalComponent } from '@muixer/ui';
...
@Component({
  ...
  imports: [FormsModule, AlertComponent, ButtonComponent, InputComponent, ModalComponent],
