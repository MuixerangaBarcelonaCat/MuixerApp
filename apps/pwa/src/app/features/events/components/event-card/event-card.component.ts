...
export class EventCardComponent {
  ...
  /** ANIRE + ASSISTIT (adults are `total - xicalla`, both already counted in `confirmed`/`attended`/`children`). */
  protected readonly comingTotal = computed(() => {
    const s = this.event().attendanceSummary;
