...
|| **P5.11** | **Mòdul Pinyes — Integració de Rengles** | ✅ Completat | [`docs/specs/2026-05-28-rengles-integration-spec.md`](docs/specs/2026-05-28-rengles-integration-spec.md) | [`f5_projection_polish_docs_04ec3589`](.cursor/plans/f5_projection_polish_docs_04ec3589.plan.md) | ✅ | **F1:** Rengla entity + schema + snapshot amb tots els cordons. **F2:** Editor de rengles (overlay, UX de creació). **F3:** Ghost clone (creació radial de nodes). **F4:** Selector de cordons a l'assignació (CordonsDialog, isNodeVisible, persistència). **F5:** Projecció amb filtrat cordons, cleanup codi mort (deriveNodes, upgradeInstance UI, bulkImport migrat a renglaId), documentació actualitzada |
