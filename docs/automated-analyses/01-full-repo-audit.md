...
| 7   | 🟠 [TEST-1](#7-tests) Backend auth guards & strategies at **0% coverage** — the entire authz enforcement layer is untested                                                                                    | `auth/guards`, `auth/strategies`    |
