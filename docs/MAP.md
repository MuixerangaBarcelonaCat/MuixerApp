...
> Generat el 2026-09-08 amb `pnpm run docs:map`.
...
| [`event-segment`](../apps/api/src/modules/event-segment) | 19 | 1925 | [[PINYES_MODULE]] |
...
| [`me`](../apps/api/src/modules/me) | 8 | 756 | — |
| [`news`](../apps/api/src/modules/news) | 6 | 224 | — |
| [`node-assignment`](../apps/api/src/modules/node-assignment) | 14 | 3183 | [[PINYES_MODULE]] |
| [`person`](../apps/api/src/modules/person) | 12 | 1151 | [[DATA_MODEL]] |
...
| Fitxer | Línies |
|--------|-------:|
| [`apps/api/src/modules/node-assignment/node-assignment.service.ts`](../apps/api/src/modules/node-assignment/node-assignment.service.ts) | 1890 |
| [`apps/dashboard/src/app/features/pinyes/components/template-editor/template-editor.component.ts`](../apps/dashboard/src/app/features/pinyes/components/template-editor/template-editor.component.ts) | 1242 |
| [`apps/dashboard/src/app/features/pinyes/components/segment-workspace/tabs/troncs-tab/troncs-tab.component.ts`](../apps/dashboard/src/app/features/pinyes/components/segment-workspace/tabs/troncs-tab/troncs-tab.component.ts) | 899 |
| [`apps/dashboard/src/app/features/pinyes/components/segment-workspace/tabs/pinyes-tab/pinyes-tab.component.ts`](../apps/dashboard/src/app/features/pinyes/components/segment-workspace/tabs/pinyes-tab/pinyes-tab.component.ts) | 896 |
| [`apps/dashboard/src/app/features/events/components/segment-manager/segment-manager.component.ts`](../apps/dashboard/src/app/features/events/components/segment-manager/segment-manager.component.ts) | 880 |
...
| [`apps/dashboard/src/app/features/events/components/segment-manager/segment-manager.component.html`](../apps/dashboard/src/app/features/events/components/segment-manager/segment-manager.component.html) | 668 |
| [`apps/api/src/modules/event-segment/figure-instance.service.ts`](../apps/api/src/modules/event-segment/figure-instance.service.ts) | 637 |
