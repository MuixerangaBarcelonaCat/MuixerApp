...
| WI-10 | **Pinyes**: arreglar pestanya **Distribució** en mòbil (`aside w-70` fluid + canvas mai 0px) | Pinyes | 🔴 | M | P-H1 | ✅ | 🚧 | `fix/audit-pinyes-distribucio-mobile` |
...
| 2026-07-21 | WI-10 | ✅ Aprovat → 🚧 En curs | Severitat Alta: `aside` d'amplada fixa `w-70` (280px) no cap a 393px i empeny el canvas fora de pantalla → Konva llança `InvalidStateError` (canvas amb amplada/alçada 0). Fix: aside fluid en mòbil. Branca `fix/audit-pinyes-distribucio-mobile`. |
