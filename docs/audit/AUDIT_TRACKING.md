...
| WI-05 | **Formulari Persona**: apilar etiqueta/input en mòbil | Persons | 🟠 | S | PE-M3(layout) | ✅ | 🟣 | `fix/audit-person-form-stack` (pendent d'obrir PR) |
| WI-06 | **Detall Persona**: `flex-wrap` a les barres de botons (no tallar en mòbil) | Persons | 🟠 | S | PE-M2 | ✅ | 🟣 | `fix/audit-person-detail-buttons` (pendent d'obrir PR) |
