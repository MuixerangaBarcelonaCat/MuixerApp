...
| WI-03 | **Normalitzar tap targets ≥24px** (chips, checkboxes, enllaços, badges) | Transversal | 🟠 | M | PE-L1, PE-L2, EV-M3, CF-L1, PW-L3, PW-L4 | ✅ | 🟣 | `fix/audit-tap-targets` (pendent d'obrir PR) |
